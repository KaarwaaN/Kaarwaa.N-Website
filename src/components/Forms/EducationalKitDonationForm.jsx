...
function EducationalKitDonationForm({closeForm}) {
  ...
  return (
    ...
    <h2 className="text-xl font-semibold text-center mb-4">Educational Kit Donation</h2>
    
   
    <p className="text-gray-600 text-center tex-sm mb-2">Donate Saraswati to needy kids and build a future</p>
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-md mx-auto p-4 bg-white shadow-md rounded-lg">
      ...
      <div className="mb-4">
        <label className="block text-gray-600 text-xs font-semibold mb-2">Describe What Study Material You Want to Donate</label>
        <textarea
